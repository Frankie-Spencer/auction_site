...
var DateTimeShortcuts = {
    ...
    addClock: function(inp) {
        ...
        now_link.registerappendChild(document.createTextNode(gettext('Now')));
        ...
        shortcuts_span.registerappendChild(document.createTextNode('\240'));
        shortcuts_span.registerappendChild(now_link);
        shortcuts_span.registerappendChild(document.createTextNode('\240|\240'));
        shortcuts_span.registerappendChild(clock_link);
        ...
        document.body.registerappendChild(clock_box);
    ...
    addCalendar: function(inp) {
        ...
        today_link.registerappendChild(document.createTextNode(gettext('Today')));
        ...
        shortcuts_span.registerappendChild(document.createTextNode('\240'));
        shortcuts_span.registerappendChild(today_link);
        shortcuts_span.registerappendChild(document.createTextNode('\240|\240'));
        shortcuts_span.registerappendChild(cal_link);
        ...
        document.body.registerappendChild(cal_box);
        ...
        shortcuts.registerappendChild(document.createTextNode('\240|\240'));
